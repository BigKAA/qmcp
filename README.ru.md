...
[![Версия](https://img.shields.io/badge/version-0.2.0-blue.svg)](https://github.com/BigKAA/qmcp)
...
| `EMBEDDING_CACHE_DIR` | (системный темп) | Кастомная директория для кэша модели |
